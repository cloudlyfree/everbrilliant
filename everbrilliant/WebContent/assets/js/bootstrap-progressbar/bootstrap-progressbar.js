            ...
            setTimeout(function() {
                ...
                var progress = setInterval(function() {
                    ...
                    if (options.display_text !== $.fn.progressbar.display_text.none) {
                        text = options.use_percentage ? (current_percentage +'%') : (current_value + ' ' + options.use_unit + ' / ' + amount_total + ' ' + options.use_unit);
                        text = options.use_title ? (options.use_title + '：' + text) : text;
