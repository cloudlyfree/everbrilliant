...
!function( $ ) {
	...
	Datetimepicker.prototype = {
		...
		hide: function(e){
			...
			this.picker.hide();
			if(this.picker.hasClass("other")) this.picker.removeClass("other");
		...
		place: function(){
			...
			var distance = this.picker.offset().top + this.picker.height() - $(window).scrollTop() - $(window).height() + 10;
			if(distance > 0)
			this.picker.css({
				top: offset.top + this.height - distance + "px"
			}).addClass("other");	
		},
