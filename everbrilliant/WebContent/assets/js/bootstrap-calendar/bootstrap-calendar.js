...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'Calendar',
        ...
        defaults = {
            ...
            msg_months: ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"],
            msg_today: '今天',
            msg_events_header: '当天事件',
            events: null
        },
    ...
    Plugin.prototype.renderCalendar = function (date) {
        ...
        this.element.parent('div:first').find('.__year').empty();
        this.element.parent('div:first').find('.__month').empty();

        this.element.parent('div:first').find('.__year').append(mon.getFullYear());
        this.element.parent('div:first').find('.__month').append(this.months[mon.getMonth()]);
