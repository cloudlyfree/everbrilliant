                ...
                <tr>\
                    <td width="50%">\
                        <div class="selector-available">\
                            ...
                            <a href="#" class="selector-chooseall">全选</a>\
                        </div>\
                    </td>\
                    <td>\
                        <div class="selector-chooser">\
                            <a href="#" class="selector-add">添加</a>\
                            <a href="#" class="selector-remove">删除</a>\
                        </div>\
                    </td>\
                    <td width="50%">\
                        <div class="selector-chosen">\
                            ...
                            <div class="selector-filter right">\
                                <p>选中并点击</p><span class="illustration"></span>\
                            </div>\
                            <select multiple="multiple" class="filtered target">\
                            </select>\
                            <a href="#" class="selector-clearall">取消全选</a>\
                        </div>\
                    </td>\
                </tr>\
            </table>',
