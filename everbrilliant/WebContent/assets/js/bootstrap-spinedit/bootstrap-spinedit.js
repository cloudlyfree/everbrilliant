...
if (!isNaN(initialValue)) value = initialValue.toFixed(this.numberOfDecimals);	
        ...
        template.find('.spinner-up').mousehold($.proxy(this.increase, this));
        template.find('.spinner-down').mousehold($.proxy(this.decrease, this));
...
options = typeof option == 'object' && option;
    ...
    DRPGlobal.template =
        ...
        '<button class="spinner-button spinner-up"><i class="icon-chevron-up"></i></button>' +
        '<button class="spinner-button spinner-down">'+
